...
public class Main {
	public static void main(String[] agrs) throws IOException {
		...
		World w=new World(largeur,hauteur,0,0,1,width,height); // (largeur_monde, hauteur_monde, nb_arbre, nb_animal,nb_de_volcan_a_la_foix_max, largeur_fenetre,hauteur_fenetre)
